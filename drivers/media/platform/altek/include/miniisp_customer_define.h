...
/*boot spinor file location*/
#define BOOT_SPINOR_FILE_LOCATION "/data/firmware/miniBoot_spinor.bin"
/*basic code location*/
...
/*AE tunning data location*/
#define AE_TUNNING_DATA_FILE_LOCATION "/data/firmware/AE.bin"
...
/*wp*/
#define WP_GPIO "wp-gpios" /*"wp-gpios"*/
