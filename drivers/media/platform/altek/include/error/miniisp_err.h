...
#define   ERR_MINIISP_BUFFERSIZE_OVERFLOW \
			(ERR_BASE_PJ_MINIISP + 0x000)
#define   ERR_MINIISP_REQUESTFIRMWARE_FAILED \
			(ERR_BASE_PJ_MINIISP + 0x001)
#define   ERR_MINIISP_GETDATA_TIMEOUT \
			(ERR_BASE_PJ_MINIISP + 0x002)
#define   ERR_MINIISP_PARAM_ERROR \
			(ERR_BASE_PJ_MINIISP + 0x003)
#define   ERR_MINIISP_DEVDATA_NULL \
			(ERR_BASE_PJ_MINIISP + 0x004)
