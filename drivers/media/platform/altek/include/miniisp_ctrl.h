 ...
 *\return Error code
 */
extern errcode mini_isp_drv_read_calibration_data(u8 calib_id);
...
extern errcode mini_isp_drv_isp_smart_ae_control(u8 on);

extern errcode mini_isp_drv_set_group_led_level(
	struct ISPCMD_LED_LEVEL *param);

extern errcode mini_isp_drv_set_ctrl_led_seq(
	struct ISPCMD_CTRL_LED_SEQ *param);

extern errcode mini_isp_drv_host_ctrl_led_onoff(
	struct ISPCMD_CTRL_GPO *param);

extern errcode mini_isp_drv_extra_sensor_sync(u8 sync_ratio);

extern errcode mini_isp_drv_set_depth_type(
	struct ISPCMD_DEPTH_TYPE *param);

extern errcode mini_isp_drv_get_chip_thermal(u16 *thermal_val);

extern errcode mini_isp_drv_get_peripheral_device(
		struct isp_cmd_peripheral_info *peripheral_info);

extern errcode mini_isp_drv_set_peripheral_device(
		struct isp_cmd_peripheral_info *peripheral_info);

extern errcode mini_isp_drv_get_binfile_ver(void);
extern errcode mini_isp_drv_bulk_get_binfile_ver(void);
